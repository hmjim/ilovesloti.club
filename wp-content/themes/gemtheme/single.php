		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="main-game">
					...
					<a href="<?php the_field('home_link') ?>" class="btn btn-green btn-fullwidth"><i class="fa fa-usd" aria-hidden="true"></i> Играть на деньги</a>
				</div>
			</div>
			...
			<div class="col-lg-3">
				<div class="similar-games">
					...
					<div class="owl-carousel similar-carousel">
						...
						$exclude = array();
						$exclude[]=get_the_id();
						$posts = get_posts( array('numberposts' => 9, 'post_type' => 'post', 'post__not_in' => $exclude  ) ); 
						...
						<?php if($counter == 0 OR $counter % 3 == 0): ?>
							...
							<div class="casino-item">
								<div class="casino-icon">
									<img src="<?php echo kama_thumb_src("w=160 &h=116"); ?>">
							...
							<?php $counter++; if($counter == 3 OR $counter % 3 == 0): ?>
						</div><!-- итем -->
					<?php endif; ?>
...
<div class="pluso" data-background="transparent" data-options="small,square,line,horizontal,counter,theme=01" data-services="vkontakte,odnoklassniki,facebook,twitter"></div>
</div>
</div>
