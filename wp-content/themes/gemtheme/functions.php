...
function clrs_get_attachment_url( $url, $post_id ) {
	...
	return str_replace( 'https://ilovezzlotizz.nw.r.appspot.com', '//2ilovesloti.com', $url );
}
...
function change_image_url( $content ) {
	return str_replace( 'https://ilovezzlotizz.nw.r.appspot.com/wp-content/uploads/', '//2ilovesloti.com/wp-content/uploads/', $content );
}
