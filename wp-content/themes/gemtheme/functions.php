...
function pagination() { // функция вывода пагинации
	...
	echo paginate_links(array( // вывод пагинации с опциями ниже
		...
		'prev_text'    => '<i class="fa fa-angle-left" aria-hidden="true"></i> <span>Предыдущая</span>', // текст назад
		'next_text'    => '<span>Следующая</span> <i class="fa fa-angle-right" aria-hidden="true"></i>', // текст вперед
