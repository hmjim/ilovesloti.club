							...
							<?php if( have_rows('game_homes', 'option') ): ?>
								...
								<?php while( have_rows('game_homes', 'option') ): the_row(); 
									...
									<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
										<div class="banner-item"><a href="<?php echo $link; ?>" target="_blank"><img src="<?php echo kama_thumb_src("w=270 &h=133", $image); ?>" title="<?php echo $image_data->post_title; ?>" alt="<?php echo get_post_meta($image, '_wp_attachment_image_alt', true); ?>" ></a></div>
									</div>
