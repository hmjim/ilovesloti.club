								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="casino-item">
										<div class="casino-icon">
											<img src="<?php echo kama_thumb_src("w=194 &h=141") ?>" title="Игровой автомат <?php the_title(); ?>">
											<div class="casino-btns">
												<a href="<?php the_field('home_link') ?>" title="Играть в <?php the_title(); ?> на деньги">Играть на деньги</a>
												<a href="<?php the_permalink(); ?>" title="Играть в <?php the_title(); ?>">Играть бесплатно</a>
											</div>
										</div>
